                ...
                <table class="table">
                    ...
                    <tbody>
                     ...
                     <tr>
                      ...
                      <td>{{ $name->name}}</td>
                      <td class="car-img">
                  <img src="/categoryimage/{{$name->image}}"  alt="">
                </td>
                      <td>{{ $name->status}}</td>
                      <td>
                        <a href="{{url('/editautopartcategory', $name->id )}}" class="btn btn-info btn-sm">Edit</a>
                        <a href="{{url('/deleteautopartcategory', $name->id )}}" class="btn btn-danger btn-sm">Delete</a>
                      </td>
                     </tr> 
                     @endforeach
                    </tbody>
