                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <div class="form-group">
                        ...
                        <input type="text" name="servicename" value="{{$service->servicename}}" id="owner_name" placeholder="Enter your vehicle" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-8">
                      <div class="form-group">
                        <label  class="font-weight-bolder text-dark">Description</label>
                        <input  type="text" name="description" value="{{$service->description}}" id="owner_name" placeholder="Enter your vehicle" class="form-control">
                      </div>
                    </div>
