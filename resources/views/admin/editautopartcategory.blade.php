                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="checkbox" name="status" value="{{ $data->status == '1' ? 'checked' : ''}}" class="form-control" >
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <textarea name="meta_keyword"  rows="3">{{ $data->meta_keyword}}</textarea>                      
                       </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="font-weight-bolder text-dark">Meta-Description</label>
                        <textarea name="meta_description"  rows="3">{{ $data->meta_description }}</textarea>
                      </div>
                    </div>
                  </div>
