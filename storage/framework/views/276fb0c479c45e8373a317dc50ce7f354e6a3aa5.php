<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  ...
                  <span class="title"> AUTO SERVICES</span>
                     ...
                     <a href="/serviceform" class="cta-main cta-secondary">SERVICE REQUEST</a>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box_text">
      ...
      <!-- three_box -->
      <!--  footer -->
     <?php echo $__env->make('contactus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Autozone1\resources\views/home.blade.php ENDPATH**/ ?>