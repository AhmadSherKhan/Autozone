...
<div class="container my-4">
    <div><span class="badge mb-4">NOTE:</span>  Please enter correct details for your booking. These details are necessary to verify your identity</div>
      ...
      <div class="card p-4 my-4">
        ...
        <?php endif; ?>
      <form action="<?php echo e(url('/serviceform')); ?>" method="POST" >
...
<?php echo $__env->make('contactus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Autozone\resources\views/serviceform.blade.php ENDPATH**/ ?>