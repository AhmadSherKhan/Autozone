              ...
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                     <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cli): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <tr>
                      <th><?php echo e($cli->id); ?></th>
                      <td><?php echo e($cli->name); ?></td>
                      <td><?php echo e($cli->email); ?></td>
                      <td><?php echo e($cli->isAdmin == '1' ? 'Admin' : 'User'); ?></td>
                      <td>
                        <a href="<?php echo e(url('admin/users', $cli->id )); ?>" class="btn btn-info btn-sm">Edit</a>
                      </td>
                     </tr> 
...
</html><?php /**PATH E:\Autozone\resources\views/admin/users.blade.php ENDPATH**/ ?>