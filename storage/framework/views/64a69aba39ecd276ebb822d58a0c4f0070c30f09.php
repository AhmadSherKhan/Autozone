                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <label class="font-weight-bolder text-dark">Car Name</label>
                        <input type="text" name="carname" value="<?php echo e($data->carname); ?>" class="form-control" placeholder="Enter category name" >
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="font-weight-bolder text-dark">Price</label>
                        <input type="text" name="price" value="<?php echo e($data->price); ?>" class="form-control" >
                      </div>
                    </div>
                    <div class="col-md-6">
                        <label  class="font-weight-bolder text-dark">Image</label>
                        <input type="file" name="file" value="<?php echo e($data->image); ?>">
                        <img src="/carimage/<?php echo e($data->image); ?>">
                    </div>
                  </div>
...
</html><?php /**PATH E:\Autozone1\resources\views/admin/editrentcar.blade.php ENDPATH**/ ?>