          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <img src="<?php echo e(asset( $item->productimages[0]->image)); ?>" alt="">
                </td>
                <td><?php echo e($item->price); ?></td>
                <td><?php echo e($item->quantity); ?></td>
                <td><?php echo e($item->status == '1' ? 'Hidden' : 'Visible'); ?></td>
                <td>
                  <a href="<?php echo e(url('/editproduct', $item->id )); ?>" class="btn btn-primary">Edit</a>
                  <a href="<?php echo e(url('/deleteproduct', $item->id )); ?>" onclick="return confirm('Are you sure yo want to delete it?')" class="btn btn-danger">Delete</a>
                </td>
              </tr>
...
</html><?php /**PATH E:\Autozone\resources\views/admin/autopartlist.blade.php ENDPATH**/ ?>