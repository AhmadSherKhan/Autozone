                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <div class="form-group">
                        ...
                        <input type="text" name="category" class="form-control" placeholder="Enter descriptions about product">
                      </div>
                    </div>
                    <div class="col-md-8">
...
</html><?php /**PATH E:\Autozone1\resources\views/admin/addautopart.blade.php ENDPATH**/ ?>