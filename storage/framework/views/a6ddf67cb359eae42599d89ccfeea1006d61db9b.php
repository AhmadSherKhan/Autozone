      ...
      <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cars): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="carbox">
          ...
          <div class="price">
            ...
            <span>Per Day</span>
            <a href="<?php echo e(url('/rentform/'.$cars->id)); ?>"  class="btn rent-btn btn-primary" style="margin-top:1.5rem;">Book</a>
          </div>
        </div>
...
</html><?php /**PATH E:\Autozone\resources\views/categories.blade.php ENDPATH**/ ?>